...
namespace Part_1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Wire A in Part 1 ended up with 16076. I will add that to the dictionary directly for Part 2, and then re-run the code.
            ...
            myDic.Add("b", 16076); //Directly adding a value for Part 2 of the puzzle
